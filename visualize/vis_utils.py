...
class npy2obj:
    def __init__(self, npy_path, sample_idx, rep_idx, device=0, cuda=True):
        ...
        self.motions['motion']=self.motions['motion'].reshape(-1,22,3,196)
    ...
    def save_npy(self, save_path):
        real_num_frames = int(self.real_num_frames)
        data_dict = {
            'motion': self.motions['motion'][0, :, :, :real_num_frames],
            'thetas': self.motions['motion'][0, :-1, :, :real_num_frames],
            'root_translation': self.motions['motion'][0, -1, :3, :real_num_frames],
            'faces': self.faces,
            'vertices': self.vertices[0, :, :, :real_num_frames],
