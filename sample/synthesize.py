...
from draw_sketches import draw_sketches, draw_joints
...
def main():
    ...
    for rep_i in range(args.num_repetitions):
        ...
        # Recover XYZ *positions* from HumanML3D vector representation: [10,22,3,196]
        ...
        draw_sketches(sample[...,0],"visualization" ,0, None,"black")
        draw_joints(sample[...,0],"visualization" ,1, None,"black")
